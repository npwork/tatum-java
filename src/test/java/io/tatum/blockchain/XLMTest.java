...
public class XLMTest {
    ...
    @Test
    public void xlmGetAccountInfoTest() throws InterruptedException, ExecutionException {
        XLM xlm = new XLM();
    ...
    @Test
    public void xlmGetCurrentLedgerTest() throws InterruptedException, ExecutionException {
        XLM xlm = new XLM();
    ...
    @Test
    public void xlmGetLedgerTxTest() throws ExecutionException, InterruptedException {
        XLM xlm = new XLM();
    ...
    @Test
    public void xlmGetTransactionTest() throws ExecutionException, InterruptedException {
        XLM xlm = new XLM();
    ...
    @Test
    public void xlmGetAccountTransactions() throws ExecutionException, InterruptedException {
        XLM xlm = new XLM();
